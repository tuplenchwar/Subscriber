...
public class SubscriberService {
    ...
    public CopyOnWriteArrayList<String> getAvailableTopics(String subscriberUrl) {
        int retryCount = 0;
        ...
        while (retryCount < maxRetries) {
            ...
            try {
                String url = leaderBrokerUrl + "/broker/gettopics?subscriberConnectionURL=" + subscriberUrl;
